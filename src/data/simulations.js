    ...
    simulations: [
      {
        ...
        tagType: 'algebra',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop6-truc-so-nguyen/index.html',
        description:
      ...
      },
      {
        ...
        tagType: 'geometry',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop6-doi-xung-hinh-phang/index.html',
        description:
  ...
  },
  {
    ...
    simulations: [
      ...
      // },
      {
        ...
        tagType: 'geometry',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop7-duong-dong-quy/index.html',
        description:
    ...
    simulations: [
      {
        ...
        tagType: 'algebra',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop8-hang-dang-thuc/index.html',
        description:
      ...
      },
      {
        ...
        tagType: 'algebra',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop8-do-thi-bac-nhat/index.html',
        description:
    ...
    simulations: [
      {
        ...
        tagType: 'algebra',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop9-ban-bong-parabol/index.html',
        description:
      ...
      },
      {
        ...
        tagType: 'geometry',
        status: 'Sẵn sàng',
        legacyPath: '/src/simulations/lop9-goc-noi-tiep/index.html',
        description:
    ...
    simulations: [
      {
        ...
        tagType: 'algebra',
        status: 'Lớp 6–9',
        legacyPath: '/src/simulations/xac-suat-thong-ke/index.html',
        description:
      ...
      },
      {
        ...
        tagType: 'algebra',
        status: 'Lớp 8–12',
        legacyPath: '/src/simulations/xac-suat-thong-ke/index.html#freq',
        description:
